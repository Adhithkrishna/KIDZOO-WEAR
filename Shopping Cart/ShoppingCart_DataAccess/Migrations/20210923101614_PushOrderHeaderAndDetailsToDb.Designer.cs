...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoppingCart_Models.InquiryDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShoppingCart_Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShoppingCart_Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShoppingCart_Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ShoppingCart_Models.InquiryDetails", b =>
                {
                    b.HasOne("ShoppingCart_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShoppingCart_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingCart_Models.InquiryHeader", b =>
                {
                    b.HasOne("ShoppingCart_Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingCart_Models.OrderDetails", b =>
                {
                    b.HasOne("ShoppingCart_Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("ShoppingCart_Models.OrderHeader", b =>
                {
                    b.HasOne("ShoppingCart_Models.ApplicationUser", "CreatedBy")
                        .WithMany()
